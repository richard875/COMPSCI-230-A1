...
public class A1 extends JFrame implements KeyListener {
	AnimationPanel panel;  // panel for bouncing area
	JButton startButton, stopButton, borderButton, fillButton, infoButton, upButton, downButton, deleteButton, deleteAll, moveUsingKeyboard;  //buttons to start and stop the animation
	...
	* @return toolsPanel		the Panel */
	public JPanel setUpToolsPanel() {
		...
		ImageIcon textButton = createImageIcon("text.png");
		shapesComboBox = new JComboBox<ImageIcon>(new ImageIcon[] {recangletButtonIcon,squareButtonIcon,ellipseButtonIcon, pyramidButton, overlappedButton, textButton});
		...
		deleteAll.addActionListener( new ActionListener() {
			public void actionPerformed( ActionEvent e) {
					panel.clearAllShapes();
			}
		});
		
		//Set up the up button
		moveUsingKeyboard = new JButton("Move");
		moveUsingKeyboard.setToolTipText("Move using keyboard");
		moveUsingKeyboard.addKeyListener(this);
		//--------End----------------------------------------------------
		...
		toolsPanel.add(deleteAll);
		toolsPanel.add(moveUsingKeyboard);
		return toolsPanel;
	}
