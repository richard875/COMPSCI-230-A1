...
public abstract class MovingShape implements Comparable<MovingShape> {
    ...
    public void scaleUp() {
        int newWidth = (int) Math.floor(this.width + this.width * 0.1);
        setWidth(newWidth);
        int newHeight = (int) Math.floor(this.height + this.height * 0.1);
        setHeight(newHeight);
    } //complete this
    ...
    public class FallingPath extends MovingPath {
        ...
        public void move() {
            ...
            if((y + height > marginHeight) && (deltaY > 0)) {
                y = 0;
            }
        }
    }
