// Richard Lee
// rli315
// This is the Animation Panel File
...
public class AnimationPanel extends JComponent implements Runnable {
    ...
    protected void createNewShape(int x, int y) {
        ...
        switch (currentShapeType) {
            ...
            case 4: {
             ...
             case 5: {
                shapes.add(new MovingText(x, y, currentWidth, currentHeight, marginWidth, marginHeight, currentBorderColor, currentFillColor, currentPath));
                break;
            }
       }
    }
    ...
    public String getSortedInfo() {
        ...
        for (int i = 0; i < shapes.size()-1; i++) {
            toRet.append(shapes.get(i));
            toRet.append("\n");
        }
        toRet.append(shapes.get(shapes.size()-1));
